...
probability by sub-Gaussian spectral concentration~\cite{bai_silverstein} at rate $O(1/\sqrt{n})$.
\end{proof}

\subsection{Phase Transition Characterization}

Figure~\ref{fig:mp_detection} (Appendix~\ref{app:experiments}) visualizes the eigenvalue
separation and empirical detection rate as a function of $\sigma^2\beta^2$.
