...
\label{lem:closure}
Once Spectral Sentinel enters a legitimate configuration at round $t_0$, it remains legitimate for all $t \geq t_0$ with probability $1 - \delta$, where $\delta = O(e^{-k/\log^2 k})$ per round.
\end{lemma}
