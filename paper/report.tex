...
\begin{document}
    ...
    \title{Spectral Sentinel: A Self-Stabilizing Byzantine-Robust Federated Learning System via Sketched Random Matrix Theory on Blockchain}
...
\begin{IEEEkeywords}
Self-Stabilization, Byzantine Fault Tolerance, Federated Learning, Random Matrix Theory, Distributed Systems, Blockchain, Marchenko-Pastur Law
\end{IEEEkeywords}
...
\section{Self-Stabilization Properties (SSS 2026 Track)}
