...
Detailed memory-vs.-parameter curves across four sketch sizes, sketch-size ablation, layer-wise vs.\ full-model detection tradeoffs, and threshold adaptation results are in Appendix~\ref{app:experiments} and~\ref{app:ablation}.
